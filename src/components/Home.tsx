    ...
    <div className="h-screen bg-[url('/public/images/bg.png')] bg-cover bg-center w-screen">
      ...
      <div className="text-center flex items-center justify-center mx-4 md:mx-14 px-4 ">
        <div className="py-16 space-y-4">
          {/* Main Heading */}
          <p className="font-bold line  text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl ">
          ...
          <div className="pt-8 sm:pt-12">
            <button className="focus:outline-none bg-white text-[#0737A5] w-40 sm:w-48 md:w-52 lg:w-56 rounded-b-lg font-bold rounded-tr-lg py-2">
              Get In Touch
            </button>
          </div>
        </div>

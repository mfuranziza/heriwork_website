...
const About = () => {
  return (
    <div className="py-12 w-full">
      <div className="flex flex-col md:flex-row items-center  gap-28  w-full h-auto px-4 sm:px-10 md:px-20 lg:px-32">
        ...
        <div className=" w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="mt-4 text-sm sm:text-base linehe  lg:px-0  text-[#7A7A7A]  leading-10  ">
          ...
          <button className="mt-6 bg-[#04192D] text-white px-16 py-2 rounded-lg">
            Contact Us
          </button>
        </div>
      </div>
